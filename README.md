...
| Atributo | Detalle |
|---|---|
| Archivo | `Delinquency_prediction_dataset.xlsx` |
...
Carga de datos
      ↓
Revisión estructural (shape, dtypes, duplicados)
      ↓
...
Tratamiento y limpieza
      ↓
Dataset listo para modelamiento
```
...
Este repositorio forma parte del portafolio de datos de **Evelyn Cabrera Arias**, Analytics Translator Senior con más de 10 años de experiencia en banca, riesgo crediticio y cobranza.
